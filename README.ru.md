...
Разница только в дополнительной проверке типа и дополнительном функционале, который могут предложить типизированные методы, например,  можно залать значение по умолчанию, если извлекаемых данных нет в кеше:
```csharp
...
[шаблон Заместитель](https://en.wikipedia.org/wiki/Proxy_pattern). С выходом .NET Framework 4.0, 
в котором представлено пространство имён `System.Runtime.Caching` и несколько классов с новой моделью кэширования, 
