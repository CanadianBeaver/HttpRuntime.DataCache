...
При этом основной код приложения не должен изменяться, запросы на извлечение из кэша должны возвращать `null`, а добавадение данных в кэш не должно ничего менять.
